...
{% linked_images :files => ['proto-helo.jpg', 'proto-wiring.jpg'], :alt_texts => ['First prototype', 'Prototype wiring'] %}
...
{% linked_images :files => ['pcb-front.jpg', 'pcb-back.jpg'], :alt_texts => ['PCB front', 'PCB back'] %}
...
{% linked_images :files => ['discretes.jpg', 'ics-installed.jpg'], :alt_texts => ['Discrete components installed', 'ICs installed in sockets'] %}
...
{% linked_image :file => 'running.jpg', :alt_text => 'Assembled SBC running a test routine' %}
